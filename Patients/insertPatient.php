...
// Prepare and bind
$stmt = $conn->prepare("INSERT INTO patients (PatientID, FirstName, LastName, Email, Phone, DOB, Address, Gender, InsuaranceName, InsuaranceID) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
$stmt->bind_param("isssssssss", $PatientID, $FirstName, $LastName, $Email, $Phone, $DOB, $Address, $Gender, $InsuaranceName, $InsuaranceID);
